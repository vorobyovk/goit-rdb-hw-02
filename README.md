...
- `1_1nf_normalization.png` - скріншот нормалізації до 1НФ
  ![Нормалізація до 1НФ](screenshots/1_1nf_normalization.png)
- `2_2nf_normalization.png` - скріншот нормалізації до 2НФ
  ![Нормалізація до 2НФ](screenshots/2_2nf_normalization.png)
- `3_3nf_normalization.png` - скріншот нормалізації до 3НФ
  ![Нормалізація до 3НФ](screenshots/3_3nf_normalization.png)
- `4_er_diagram.png` - скріншот ER-діаграми
  ![ER-діаграма](screenshots/4_er_diagram.png)
- `5_database_schema.png` - скріншот схеми бази даних
  ![Схема бази даних](screenshots/5_database_schema.png)
